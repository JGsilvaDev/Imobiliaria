    ...
    public function detalhe($id){
        ...
        $item =  DB::table('catalogos')
                    ...
                    ->select('catalogos.id','catalogos.descricao as desc','catalogos.id_tp_produto',
                      ...
                      'catalogos.moveisPlanejados','catalogos.portaoEletronico','catalogos.quintal', 'catalogos.tp_contrato', 'catalogos.vendidoAlugado', 'catalogos.qtdSacadasCobertas', 'catalogos.cozinhaConjugada', 'catalogos.porteiroEletronico')
